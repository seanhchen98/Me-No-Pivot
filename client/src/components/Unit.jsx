  ...
  return (
    <div className="container" style={{height: 80}}>
      <div className="">
        ...
        <div className="">
          <figure class="image is-48x48" style={{border: `3px solid ${color}`}}>
...
const checkStage2Units = (championId) => {
  if (championId === 'tft5_fiddlesticks' || championId === 'tft5_gwen' || championId === 'tft5_missfortune' || championId === 'tft5_pyke' || championId === 'tft5_senna' || championId === 'tft5_tristana' || championId === 'tft5_rakan' || championId === 'tft5_lucian' || championId === 'tft5_irelia' || championId === 'tft5_olaf' || championId === 'tft5_akshan' || championId === 'tft5_galio' || championId === 'tft5_') {
